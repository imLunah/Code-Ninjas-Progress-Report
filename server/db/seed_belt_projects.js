// Run with: node server/db/seed_belt_projects.js
// Clean reseed — wipes belt_level_projects and re-inserts the full CREATE
// curriculum (belts White–Black + bonus tracks Bronze/Silver/Platinum).
...
async function run() {
  ...
  try {
    ...
    await client.query('DELETE FROM belt_level_projects');
    ...
    console.log(`Done. Projects inserted: ${inserted}`);
  } catch (err) {
