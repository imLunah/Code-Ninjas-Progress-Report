...
export default function TodayBoard({ assignments, onRemove }) {
  ...
  const renderCard = (a) => {
    ...
    const borderClass = a.completed
      ? 'border-green-400'
      : isOverdue
      ? 'border-red-400'
      : 'border-yellow-300';

    const dotClass = a.completed
      ? 'bg-green-500'
      : isOverdue
      ? 'bg-red-400'
      : 'bg-yellow-400';
              ...
              confirmId === a.id ? (
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="text-xs font-ninja font-semibold text-white bg-ninja-red px-2 py-0.5 rounded-lg"
                  >
                    Remove
                  </button>
                  <button
                ...
                <button
                  ...
                  className="text-ninja-muted hover:text-ninja-red transition-colors text-sm leading-none"
