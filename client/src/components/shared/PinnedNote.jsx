      ...
      {editing ? (
        <div className="space-y-2">
          <textarea
            ...
            rows={3}
            placeholder="e.g. Gets frustrated easily — celebrate small wins. Stays focused with a visible timer. Benefits from a short break halfway through. Loves building games, responds well to challenges. Enjoys creative coding projects, works well independently, and responds positively to encouragement."
