        ...
        {isCustomBelt ? (
          <div className="space-y-1.5">
            <input
              ...
              placeholder="e.g., Post-Red, Advanced, Special..."
              ...
              autoFocus
            />
            <p className="text-ninja-muted font-ninja text-xs">Belt progression won't be updated — this label is for the session record only.</p>
            <button
              type="button"
